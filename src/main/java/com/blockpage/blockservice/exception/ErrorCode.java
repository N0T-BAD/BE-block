...
public enum ErrorCode {
    ...
    //feign client
    KAKAO_SERVICE_SERVER_UNAVAILABLE("카카오 서비스가 이용이 불가능합니다.", HttpStatus.NO_CONTENT),         //오류 메세지 검토 필요
    KAKAO_SERVICE_CLIENT_BAD_REQUEST("카카오 서비스에 잘못된 요청을 보냈습니다.", HttpStatus.NO_CONTENT),     //오류 메세지 검토 필요

    BLOCK_SERVICE_SERVER_UNAVAILABLE("블록 서비스가 이용이 불가능합니다.", HttpStatus.NO_CONTENT),         //오류 메세지 검토 필요
    BLOCK_SERVICE_CLIENT_BAD_REQUEST("블록 서비스에 잘못된 요청을 보냈습니다.", HttpStatus.NO_CONTENT),     //오류 메세지 검토 필요
